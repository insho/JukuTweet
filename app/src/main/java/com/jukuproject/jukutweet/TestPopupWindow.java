...
//        }
        ...
        mAdapter = new ChooseFavoritesAdapter(mContext, mMetrics.density, mRxBusTweetBreak,mFavoritesLists, mKanjiId);
        mRecyclerView.setAdapter(mAdapter);
        mRecyclerView.setItemViewCacheSize(mFavoritesLists.size());
