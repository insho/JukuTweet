...
public class UserDetailPopupFragment extends DialogFragment implements View.OnTouchListener {
...
//        txtFollowersCount.setText(mUserInfo.getFollowerCountString());
        //TODO clean this up
        btnShowFollowingToggle.setText(mUserInfo.getFriendCountString() + " Following");
...
//        popupWindow.showAtLocation(baseLayout,Gravity.NO_GRAVITY, 0, 0);
    }
