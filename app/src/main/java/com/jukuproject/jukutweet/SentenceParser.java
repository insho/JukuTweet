...
////                    && !(char_a + char_aNext).equals("/n")
////                    && !(char_aPrev + char_a).equals("/n")
...
//
//            Cursor dd = InternalDB.getInstance(mContext).getWordEntryForKanjiId(cleanKanjiIDs.get(index),mColorThresholds);
//
